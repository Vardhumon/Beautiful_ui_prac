        ...
        child: Column(
          ...
          children: [
            // image
              Center(
                child: ClipRRect(
                  ...
                  child: Image(image: NetworkImage(imageAddress),fit: BoxFit.cover,width: cardwidth,height: 191,),
                ),
              )
            ...
            ,Row(
              ...
              children: [
                Expanded(child: Padding(padding: EdgeInsets.symmetric(horizontal:paddingcard), child: Text(title, style: TextStyle(color: Colors.black, fontWeight: FontWeight.w600, fontSize: 18),),),)
            ...
            child: Row(
              children: [
                Expanded(child: Icon(Icons.location_on, color: Colors.grey,size: 10,),),
