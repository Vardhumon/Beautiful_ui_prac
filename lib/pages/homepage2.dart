...
import 'package:ui_project/pages/childpage.dart';

class HomePagee extends StatelessWidget {
  const HomePagee({Key? key});

  @override
  Widget build(BuildContext context) {
    List <dynamic> Homecards =[
      HomeCard(
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            //cards
            SizedBox(
              height: MediaQuery.of(context).size.height - 290, // Adjust the height as needed
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ListView.builder(
                        shrinkWrap: true,
                        itemCount: Homecards.length ~/ 2,
                        itemBuilder: (context, index) {
                          final homecard = Homecards[index];
                          return GestureDetector(
                            onTap:() {
                              Navigator.push(context, MaterialPageRoute(builder: (context) => ChildPage(homecard: homecard,) ));
                            },
                            child: homecard,
                          );
                        },
                    ...
                    Expanded(
                      child: ListView.builder(
                        ...
                        itemCount: Homecards.length ~/ 2,
                        itemBuilder: (context, index) {
                          final homecard = Homecards[index + Homecards.length ~/ 2];
                          return GestureDetector(
                            onTap: () {
                              Navigator.push(context, MaterialPageRoute(builder: (context) => ChildPage(homecard: homecard,) ));
                            },
